        ...
        <div class="animated fadeIn">
          <div class="card">
            <div class="card-header">
              <div class="row">
                <span class="col-md-4">
                    <i class="fa fa-edit"></i> Tất cả danh mục
                </span>
                <span class="col-md-4">
                </span>
              </div>
              ...
              <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                    ...
                    <a href="{{route('addcategory')}}" class="btn btn-dark">Thêm danh mục sản phẩm</a>
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-6">
                ...
                <div class="row">
                  <div class="col-sm-12 table-responsive">
                    <table class="table table-striped table-bordered datatable dataTable no-footer"
                      ...
                      <tbody>
                        @foreach ($all_category_product as $item => $show_category)  
                          <tr role="row" class="odd">
                              <td><input type="checkbox" name="" class="checkOne"></td>
                              <td class="sorting_1">{{ $show_category->category_name }}</td>
                               <td>{{ $show_category->brand_name }}</td>
                              ...
                              <td>
                                <?php 
                                 ...
                                 <a href="{{route('unactive',$show_category->category_id)}}"><span class='badge badge-success'>Hiển thị</span></a>
                                <?php
                                 }else{
                                ?>  
                                 ...
                                 <a href="{{route('active',$show_category->category_id)}}"><span class='badge badge-danger'>Ẩn</span></a>
                                <?php
                                 }
                                ?>
                              </td>
                              <td>
                              <a class="btn btn-primary btn-info-category" href="{{route('editcategory',$show_category->category_id)}}">
                                    <i class="mdi mdi-table-edit"></i>
                              </a>
                              <button type="button" class="btn btn-success btn-info-category" data-toggle="modal" data-target="#modelId1" data-url="{{route('showdesc',$show_category->category_id)}}">
                                  <i class="mdi mdi-information-outline"></i>
                              </button>

                              <button type="button" class="btn btn-danger btn-destroy-category" data-toggle="modal" data-target="#modelId" data-url="{{route('destroycategory',$show_category->category_id)}}">
