...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>@yield('title') | Sửa Chữa Điện Nước 24H Chuyên Nghiệp Phúc Lộc</title>
                        ...
                        <div class="row">
                            <div class="col-lg-1 col-md-1 col-sm-5 col-5">
                                ...
                                <div class="sticky-logo">
                                    <a href="{{route('home')}}"><img src="{{URL::to('public/frontend/assets/img/logo/dt.png')}}" alt="" /></a>
                                </div>
                                <div class="logo-small-device">
                                    <a href="{{route('home')}}"><img alt="" src="{{URL::to('public/frontend/assets/img/logo/dt.png')}}"></a>
                                </div>
                            </div>
                            <div class="col-lg-10 col-md-10 d-none d-md-block">
                                <div class="logo-menu-wrapper text-center">
                                    <div class="logo">
                                        <a href="{{route('home')}}"><img src="{{URL::to('public/frontend/assets/img/logo/pc.png')}}" alt="" /></a>
                                    </div>
                                    <div class="main-menu">
                                        <nav>
                                            <ul>
                ...
                <div class="wrap-sidebar">
                    <div class="sidebar-cart-all">
                        ...
                        <div class="cart-content">
                            <h3 style="font-family:'Times New Roman', Times, serif">Giỏ Hàng</h3>
                            <ul>
                                ...
                                <li class="single-product-cart">
                                    <div class="cart-total">
                                        <h4>Tổng : <span>{{number_format($total)}}</span></h4>
                                    </div>
                                ...
                                <div class="footer-widget mb-30">
                                    ...
                                    <div class="food-info-wrapper">
                                        ...
                                        <div class="food-address">
                                            ...
                                            <div class="food-info-content">
                                                <p><a href="#">hungthinh.engineering@gmail.com</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
