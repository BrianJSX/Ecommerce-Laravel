                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="slider-single-img slider-animated-1">
                                    <img class="animated imageLazyLoad" data-src="{{asset('storage/app/SliderImages/'.$slider->slider_img)}}" alt="slider images" width="" height="280px" >
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="product-area pb-80">
    <div class="container">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                                    <div class="new-collection-slider owl-carousel mb-30" style="box-shadow: 0 3px 3px rgba(0,0,0,0.2); border-radius:15px">
                                        @foreach ($sliderindex as $slider)
                                            @if ($slider->slider_status_new == 1)
                                                <div class="single-new-collection">
                                                    <a href="shop.html"><img style="border-radius:15px" alt="image" class="imageLazyLoad" data-src="{{asset('public/frontend/assets/img/nen_new_slider.png')}}" width="570" height="439"></a>
                            ...
                            <div class="row">
                                ...
                                @foreach ($productnew as $productnew)
                                        <div class="col-lg-6 col-md-6">
                                            <div class="product-wrapper product-height mb-45 ">
                                                <div class="product-img">
                                                    <a href="{{route('productdetailindex',$productnew->prod_slug)}}">
                                                        <img class="imageLazyLoad" data-src="{{asset('storage/app/'.$productnew->prod_code.'/'.$productnew->prod_img)}}" height="326px" height="270"  alt="">
                                                    </a>
                ...
                <div class="row">
                    @foreach ($productfeatured as $productfeatured)
                        <div class="col-md-6 col-lg-4 col-xl-3 ">
                            <div class=" product-wrapper mb-45 product-height cardBox" style="">
                                <div class="product-img">
                                        <a href="{{route('productdetailindex',$productnew->prod_slug)}}">
                                            <img class="imageLazyLoad" data-src="{{asset('storage/app/'.$productfeatured->prod_code.'/'.$productfeatured->prod_img)}}" height="326px" height="270" = alt="">
                                        </a>
                                ...
                                <div class="blog-hm-wrapper mb-40">
                                    <div class="blog-img">
                                        <a href="{{route('newsdetail',$news->news_slug)}}">
                                            <img class="imageLazyLoad" data-src="{{asset('storage/app/NewsImages/'.$news->news_img)}}" alt="{{$news->news_img}}" width="407px" height="209px">
                                        </a>
                                    </div>
                                    <div class="blog-hm-content">
                                        <h3><a href="{{route('newsdetail',$news->news_slug)}}" style="font-family:'Times New Roman', Times, serif"><b>{{Str::words($news->news_title,10,'....')}}</b></a></h3>
                                        <div class="blog-meta">
                                            <ul>
