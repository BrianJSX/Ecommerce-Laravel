...
{{-- cart content --}}
<div class="product-cart-area hm-3-padding mt-3 pt-80 pb-130">
    <div class="container-fluid">
        <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <a href="{{route('productdetailindex',$product->id)}}"><img src="{{asset('storage/app/'.$product->attributes->code.'/'.$product->attributes->img)}}" alt="" width="120" height="150"></a>
                                </td>
                                ...
                                <td class="product-cart-icon product-subtotal">
                                    ...
                                    {{-- <a href="{{route('delcart',$product->id)}}">
                                        <i class="ion-ios-trash-outline" aria-hidden="true"></i>
                                    </a> --}}
                                </td>
                            </tr>
                ...
                <div class="cart-shiping-update">
                    ...
                    <div class="update-checkout-cart">
                            {{-- <div class="update-cart">
                                <button id="btn-cart-update" class="btn-style cr-btn "><span>Cập nhật giỏ hàng</span></button>
                            </div> --}}
                        {{-- <div class="update-cart">
