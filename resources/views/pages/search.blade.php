                                ...
                                <div class="product-width col-md-6 col-xl-3 col-lg-4">
                                    <div class="product-wrapper mb-35">
                                        <div class="product-img">
                                            <a href="{{route('productdetailindex',$items->prod_slug)}}">
                                                <img src="{{asset('storage/app/'.$items->prod_code.'/'.$items->prod_img)}}" width="310px" height="375px" alt="">
                                            </a>
                                            <div class="price-decrease">
                                                <span>{{$items->prod_promotion}}</span>
                                            </div>
                                            <div class="product-action-3">
                                                <a class="action-plus-2" href="{{route('productdetailindex',$items->prod_slug)}}">
                                        ...
                                        <div class="product-content">
                                            <div class="product-title-wishlist">
                                                <div class="product-title-3">
                                                    <h4><a style="font-family:'Times New Roman', Times, serif" href="{{route('productdetailindex',$items->prod_slug)}}"><b>{{$items->prod_name}} (MSP: {{$items->prod_code}})</b></a></h4>
                                                </div>
                                            ...
                                            <div class="product-peice-addtocart">
                                                <div class="product-peice-3">
                                                        @if ($items->prod_sale < $items->prod_price && $items->prod_sale > 0 )
                                                            <span class="old">{{number_format($items->prod_price)}}VNĐ</span>
                                                            <span>{{number_format($items->prod_sale)}} VNĐ</span>
                                                        @else
                                                            <span>{{number_format($items->prod_price)}} VNĐ</span>
                                                        @endif
                                                </div>
                                                <div class="product-addtocart">
                                                    <a href="javascript:void(0)" onclick="addCartIndex('{{$items->prod_id}}')"> <i class="ti-shopping-cart"></i> Add to cart</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-list-details">
                                            <h2><a style="font-family:'Times New Roman', Times, serif" href="{{route('productdetailindex',$items->prod_slug)}}"><b>{{$items->prod_name}} (MSP: {{$items->prod_code}})</b></a></h2>
